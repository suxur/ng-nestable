/**
 * Angular Nestable 1.0.0
 *
 * Copyright (c) 2015 Joshua Payne
 * https://github.com/suxur/ng-nestable
 *
...
;(function(window, document, angular, undefined) {
	...
	}).directive('ngNestable', [
		'$compile',
		'$nestable',
		function($compile, $nestable) {
			return {
				restrict:   'A',
				require:    'ngModel',
			...
			function buildNestableHtml(model, tpl) {
				...
				model.forEach(function f(item) {
					...
					if (item.hasOwnProperty('type') && item.type == 'Item') {
						listItem.addClass('dd-nochildren');
					}
